...
#define VM_INSTRUCTION_JMP 7
#define VM_INSTRUCTION_2PUSHC 8
#define VM_INSTRUCTION_PEEKC 9
#define VM_INSTRUCTION_2RMC 10
#define VM_INSTRUCTION_JNEC 11
#define VM_INSTRUCTION_INCC 12
#define VM_INSTRUCTION_ADDC 13
#define VM_INSTRUCTION_3PEEKC 14
