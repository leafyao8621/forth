...
#define VM_INSTRUCTION_DEF 16
#define VM_INSTRUCTION_DEFA 17
#define VM_INSTRUCTION_ALLOC 18
#define VM_INSTRUCTION_MULTCSD 19
#define VM_INSTRUCTION_LDD 20
#define VM_INSTRUCTION_STD 21
