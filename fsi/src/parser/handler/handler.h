...
#define PARSER_HANDLER_RECURSE 8
#define PARSER_HANDLER_IF 9
#define PARSER_HANDLER_THEN 10
#define PARSER_HANDLER_ELSE 11
#define PARSER_HANDLER_CASE 12
#define PARSER_HANDLER_OF 13
#define PARSER_HANDLER_ENDOF 14
#define PARSER_HANDLER_ENDCASE 15
#define PARSER_HANDLER_DO 16
#define PARSER_HANDLER_LOOP 17
#define PARSER_HANDLER_PLUS_LOOP 18
#define PARSER_HANDLER_I 19
#define PARSER_HANDLER_LEAVE 20
#define PARSER_HANDLER_UNLOOP 21
#define PARSER_HANDLER_EXIT 22
#define PARSER_HANDLER_J 23
#define PARSER_HANDLER_BEGIN 24
#define PARSER_HANDLER_WHILE 25
#define PARSER_HANDLER_REPEAT 26
#define PARSER_HANDLER_UNTIL 27
#define PARSER_HANDLER_AGAIN 28
#define PARSER_HANDLER_CREATE 29
#define PARSER_HANDLER_VARIABLE 30
#define PARSER_HANDLER_ALLOT 31
#define PARSER_HANDLER_FILL 32
#define PARSER_HANDLER_CELLS 33
#define PARSER_HANDLER_DOES_GT 34
#define PARSER_HANDLER_AT 35
#define PARSER_HANDLER_BANG 36
#define PARSER_HANDLER_CAT 37
#define PARSER_HANDLER_CBANG 38
#define PARSER_HANDLER_TWO_AT 39
#define PARSER_HANDLER_TWO_BANG 40
#define PARSER_HANDLER_PLUS_BANG 41
#define PARSER_HANDLER_COMMA 42
#define PARSER_HANDLER_CCOMMA 43
#define PARSER_HANDLER_PLUS 44
#define PARSER_HANDLER_DASH 45
#define PARSER_HANDLER_ASTERISK 46
#define PARSER_HANDLER_SLASH 47
#define PARSER_HANDLER_MOD 48
#define PARSER_HANDLER_ONE_PLUS 49
#define PARSER_HANDLER_CELL_PLUS 50
#define PARSER_HANDLER_ONE_DASH 51
#define PARSER_HANDLER_TWO_ASTERISK 52
#define PARSER_HANDLER_TWO_SLASH 53
#define PARSER_HANDLER_LSFHIFT 54
#define PARSER_HANDLER_RSFHIFT 55
#define PARSER_HANDLER_AND 56
#define PARSER_HANDLER_OR 57
#define PARSER_HANDLER_XOR 58
#define PARSER_HANDLER_INVERT 59
#define PARSER_HANDLER_NEGATE 60
#define PARSER_HANDLER_GT 61
#define PARSER_HANDLER_LT 62
#define PARSER_HANDLER_EQ 63
#define PARSER_HANDLER_ULT 64
#define PARSER_HANDLER_ZERO_LT 65
#define PARSER_HANDLER_ZERO_EQ 66
#define PARSER_HANDLER_MIN 67
#define PARSER_HANDLER_MAX 68
#define PARSER_HANDLER_DUP 69
#define PARSER_HANDLER_DROP 70
#define PARSER_HANDLER_SWAP 71
#define PARSER_HANDLER_OVER 72
#define PARSER_HANDLER_NIP 73
#define PARSER_HANDLER_TWO_DUP 74
#define PARSER_HANDLER_TWO_DROP 75
#define PARSER_HANDLER_TWO_SWAP 76
#define PARSER_HANDLER_TWO_OVER 77
#define PARSER_HANDLER_QUESTION_DUP 78
#define PARSER_HANDLER_ROT 79
#define PARSER_HANDLER_PICK 80
#define PARSER_HANDLER_DEPTH 81
#define PARSER_HANDLER_GTR 82
#define PARSER_HANDLER_RGT 83
#define PARSER_HANDLER_TWO_GTR 84
#define PARSER_HANDLER_TWO_RGT 85
#define PARSER_HANDLER_CHAR 86
#define PARSER_HANDLER_CHAR_PLUS 87
#define PARSER_HANDLER_CHARS 88
#define PARSER_HANDLER_TYPE 89
#define PARSER_HANDLER_S_DOUBLE_QUOTE 90
#define PARSER_HANDLER_DOT_DOUBLE_QUOTE 91
#define PARSER_HANDLER_C_DOUBLE_QUOTE 92
#define PARSER_HANDLER_COUNT 93
#define PARSER_HANDLER_D_GT_F 94
#define PARSER_HANDLER_F_GT_D 95
#define PARSER_HANDLER_F_DOT 96
#define PARSER_HANDLER_FS_DOT 97
#define PARSER_HANDLER_F_AT 98
#define PARSER_HANDLER_F_BANG 99
#define PARSER_HANDLER_FLOATS 100
#define PARSER_HANDLER_FLOAT_PLUS 101
#define PARSER_HANDLER_F_PLUS 102
#define PARSER_HANDLER_F_DASH 103
#define PARSER_HANDLER_F_ASTERISK 104
#define PARSER_HANDLER_F_SLASH 105
#define PARSER_HANDLER_FNEGATE 106
#define PARSER_HANDLER_F_ZERO_LT 107
#define PARSER_HANDLER_F_ZERO_EQ 108
#define PARSER_HANDLER_F_LT 109
#define PARSER_HANDLER_FMIN 110
#define PARSER_HANDLER_FMAX 111
#define PARSER_HANDLER_FDUP 112
#define PARSER_HANDLER_FDROP 113
#define PARSER_HANDLER_FSWAP 114
#define PARSER_HANDLER_FOVER 115
#define PARSER_HANDLER_FROT 116
#define PARSER_HANDLER_FDEPTH 117
#define PARSER_HANDLER_FVARIABLE 118
#define PARSER_HANDLER_MLOAD_DOUBLE_QUOTE 119
#define PARSER_HANDLER_Z_DOUBLE_QUOTE 120
#define PARSER_HANDLER_U_AT 121
#define PARSER_HANDLER_U_BANG 122
#define PARSER_HANDLER_UF_AT 123
#define PARSER_HANDLER_UF_BANG 124
...
int parser_handler_z_double_quote(
    ForthParser *parser, char **iter, ForthVM *vm);
int parser_handler_u_at(ForthParser *parser, ForthVM *vm);
int parser_handler_u_bang(ForthParser *parser, ForthVM *vm);
int parser_handler_uf_at(ForthParser *parser, ForthVM *vm);
int parser_handler_uf_bang(ForthParser *parser, ForthVM *vm);
