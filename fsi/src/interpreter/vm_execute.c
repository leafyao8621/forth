...
static ForthInterpreterHandler interpreter_handler[] =
    {
        ...
        interpreter_handle_dw,
        interpreter_handle_allotc,
        interpreter_handle_ld,
        interpreter_handle_st,
        ...
        interpreter_handle_inv,
        interpreter_handle_lsl,
        interpreter_handle_lsr,
        interpreter_handle_neg,
        interpreter_handle_prevr
    };
