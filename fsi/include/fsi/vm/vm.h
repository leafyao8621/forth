...
#define VM_LOOKUP_META_PARSEEXT 0x80
...
#define VM_INSTRUCTION_ULDD 100
#define VM_INSTRUCTION_USTD 101
#define VM_INSTRUCTION_ULDF 102
#define VM_INSTRUCTION_USTF 103
