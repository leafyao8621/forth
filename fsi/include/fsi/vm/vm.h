...
#define VM_INSTRUCTION_OVERD 55
#define VM_INSTRUCTION_NIPD 56
#define VM_INSTRUCTION_2DUPD 57
#define VM_INSTRUCTION_2DROPD 58
#define VM_INSTRUCTION_2SWAPD 59
#define VM_INSTRUCTION_2OVERD 60
